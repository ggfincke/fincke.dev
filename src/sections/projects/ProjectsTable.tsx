                          ...
                          <div className="flex flex-wrap gap-2">
                            {project.repoUrl && (
                              <a 
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-3 py-1 bg-[var(--card)] text-[var(--muted)] rounded-lg hover:bg-[var(--border)] hover:shadow-md transition-all duration-200 text-sm"
                              >
                            ...
                            {project.liveUrl && (
                              <a 
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-3 py-1 bg-[var(--accent)] text-[var(--bg)] rounded-lg hover:bg-opacity-90 hover:shadow-md transition-all duration-200 text-sm"
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="flex flex-wrap gap-4">
                              {project.repoUrl && (
                                <a 
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--card)] text-[var(--muted)] rounded-lg hover:bg-[var(--border)] hover:shadow-md transition-all duration-200"
                                >
                              ...
                              {project.liveUrl && (
                                <a 
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--accent)] text-[var(--bg)] rounded-lg hover:bg-opacity-90 hover:shadow-md transition-all duration-200"
                                >
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path>
                                    <polyline points="15 3 21 3 21 9"></polyline>
